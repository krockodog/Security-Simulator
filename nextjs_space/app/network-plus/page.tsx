  ...
  return (
    <div className="min-h-screen cyber-grid py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
        <Link href="/" className="inline-flex items-center text-[rgb(var(--cyber-success))] hover:text-[rgb(var(--cyber-cyan))] mb-6 transition-colors">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center mb-6">
            <div className="p-4 bg-[rgb(var(--cyber-surface))] rounded-2xl neon-cyan">
              <Network className="h-16 w-16 text-[rgb(var(--cyber-success))]" />
            </div>
          </div>
        ...
        <Card className="cyber-card">
          <CardHeader>
            ...
            <CardDescription className="text-readable-dim">Geplante Inhalte für Network+</CardDescription>
          </CardHeader>
